...
// Браузер автоматично запитує /favicon.ico для іконки вкладки. Файлу такого
// немає — без цього рядка запит падав би на глобальну вимогу авторизації
// і засмічував консоль повторюваними 401. Тепер просто тихо повертає "нема даних".
